...
$(document).ready(function(){
	...
	$("#main-logo-container").click(function(){
		...
		window.location.href="https://www.globalrelay.com";
    ...
    $('#social-widget-container >div,#social-media-container div').click(function () {
        var url = $(this).attr('rel');
        var id = $(this).attr('id');
    ...
    $('.dropdown-container .open-info').click(function(){
    	...
    	$('.dropdown-container .open-info').not(this).parent().parent().parent().next(".more-info").slideUp();
    	
    	$(this).parent().parent().parent().next(".more-info").slideDown();
    });
    ...
    $('dl.caption-container').click(function(){
    	
    	var globalTarInfo = $('.more-info-container');
    	var infoContent = $(this).children('dd.more-info').html();
    	var infoContainer = $(this).parent().parent().parent().next('.more-info-container');
    	var redPointerClass = '.red-pointer';
    	var redPointer = $(this).parent().next(redPointerClass);
    	var targetInfoContainer = infoContainer.children('.col-md-12').html;
    	
    	if(infoContainer.is(':visible')){
    		
    		if(infoContent != targetInfoContainer){
    		
    			$(redPointerClass).hide();
    			redPointer.show();
    			infoContainer.children('.col-md-12').empty().append(infoContent);
    			
    		}
    		
    	}else{
    		
    		if(globalTarInfo.is(':visible')){
    			
    			globalTarInfo.slideUp();
